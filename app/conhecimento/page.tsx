  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-[#0a0a0a] to-[#121218] text-white">
      ...
      <main className="flex-1 relative">
        ...
        <GlowEffect className="left-1/3 bottom-1/3" color="rgba(138, 43, 226,162,227,0.3)" />
        ...
        <section className="container max-w-6xl py-16 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Link href="/conhecimento/neurociencia" className="block">
              <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-300">
                ...
                <ul className="space-y-3 mb-6">
                  <li className="flex items-start">
                    ...
                    <span className="text-white">Aumento da espessura cortical em regiões associadas à atenção</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-1 h-1 rounded-full bg-blue-400 mt-2 mr-2"></span>
                    <span className="text-white">Redução da atividade da amígdala em resposta ao estresse</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-1 h-1 rounded-full bg-blue-400 mt-2 mr-2"></span>
                    <span className="text-white">Melhoria na conectividade das redes neurais de atenção</span>
                  </li>
                </ul>
            ...
            <Link href="/conhecimento/frequencias" className="block">
              <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-300">
                <div className="w-12 h-12 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 flex items-center justify-center text-white mb-6">
                ...
                <ul className="space-y-3 mb-6">
                  <li className="flex items-start">
                    <span className="inline-block w-1 h-1 rounded-full bg-blue-400 mt-2 mr-2"></span>
                    <span className="text-white">Ondas Alfa (8-12 Hz): Estado relaxado e alerta</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-1 h-1 rounded-full bg-blue-400 mt-2 mr-2"></span>
                    <span className="text-white">Ondas Theta (4-8 Hz): Meditação profunda e criatividade</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-1 h-1 rounded-full bg-blue-400 mt-2 mr-2"></span>
                    <span className="text-white">Ondas Delta (0.5-4 Hz): Sono profundo e recuperação</span>
                  </li>
                </ul>
            ...
            <Link href="/conhecimento/literatura" className="block">
              <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-300">
                <div className="w-12 h-12 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 flex items-center justify-center text-white mb-6">
                ...
                <ul className="space-y-3 mb-6">
                  <li className="flex items-start">
                    <span className="inline-block w-1 h-1 rounded-full bg-blue-400 mt-2 mr-2"></span>
                    <span className="text-white">Efeitos da meditação na cognição e atenção</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-1 h-1 rounded-full bg-blue-400 mt-2 mr-2"></span>
                    <span className="text-white">Impacto das frequências sonoras no estado mental</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-1 h-1 rounded-full bg-blue-400 mt-2 mr-2"></span>
                    <span className="text-white">Neuroplasticidade e práticas contemplativas</span>
                  </li>
                </ul>
            ...
            <Link href="/conhecimento/neurotransmissores" className="block">
              <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-300">
                <div className="w-12 h-12 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 flex items-center justify-center text-white mb-6">
                ...
                <ul className="space-y-3 mb-6">
                  <li className="flex items-start">
                    <span className="inline-block w-1 h-1 rounded-full bg-blue-400 mt-2 mr-2"></span>
                    <span className="text-white">Acetilcolina: Atenção, aprendizado e memória</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-1 h-1 rounded-full bg-blue-400 mt-2 mr-2"></span>
                    <span className="text-white">Dopamina: Motivação, recompensa e foco</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-1 h-1 rounded-full bg-blue-400 mt-2 mr-2"></span>
                    <span className="text-white">Serotonina: Humor, bem-estar e regulação do sono</span>
                  </li>
                </ul>
